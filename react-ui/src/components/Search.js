...
export default class Search extends Component {
    // !!! TODO - state needs to be lifted to App.js so it can be shared by Settings (Search is a sibling)
            ...
            <div className="search">
                ...
                <div id="instructions" className="col right-col">
                    ...
                    <div>
                        ...
                        <br></br>
                        <button className="pg1-btn" id="clear-btn" onClick={this.props.reset}>Clear list</button>
                    </div>
                </div>
            </div>
        );
